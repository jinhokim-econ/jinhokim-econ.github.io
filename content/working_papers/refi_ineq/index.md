...
summary: >-
  Mortgage refinancing responses to interest-rate declines are sharply unequal across income groups: lower-income borrowers refinance less often and with longer delays, leaving substantial unrealized savings. I show that monetary-policy easing generates a refinancing response concentrated among higher-income borrowers, and develop a structural model in which income-dependent inattention and hassle costs are necessary to match the data. Counterfactual attention interventions strengthen the consumption response to rate cuts, with most of the additional gains accruing to lower-income households.
